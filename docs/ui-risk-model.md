...
| Pattern gravity | Frequent training patterns dominate | Generic, low-trust, interchangeable output | Three-axis-plus direction search and rejected-pattern record | Novel descriptions can still render conventionally |
