...
furthering-design validate-candidate <candidate.json> [--out result.json]
...
13. Store the selected candidate, rationale, evidence, and implementation commit as durable design memory.
14. Compare production outcome signals to the original success criteria and feed the result back into future runs.
